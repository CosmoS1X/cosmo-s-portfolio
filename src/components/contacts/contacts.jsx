  ...
  <section className="contacts">
    ...
    <div className="contacts__content">
      ...
      <div className="contacts__links">
        <a className="contacts__link" href="mailto:cosmo.stan@yandex.com" target="_blank" rel="noreferrer">
        ...
        <a className="contacts__link" href="https://t.me/CosmoS1X" target="_blank" rel="noreferrer">
          <img className="contacts__ico" src={telegramIco} alt="telegram-ico" />
        </a>
        <a className="contacts__link" href="https://github.com/CosmoS1X" target="_blank" rel="noreferrer">
          <img className="contacts__ico" src={githubIco} alt="github-ico" />
        </a>
      </div>
      <div className="contacts__sublinks">
        <a className="contacts__sublink link" href="mailto:cosmo.stan@yandex.com">cosmo.stan@yandex.com</a>
        <a className="contacts__sublink link" href="tel:+79393993899">+7 (939) 399-38-99</a>
      </div>
    </div>
  </section>
);
